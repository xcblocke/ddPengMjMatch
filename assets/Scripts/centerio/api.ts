 ...
 * ========
 *
 * 1. 首次使用埋点请前往 MicrofamilyOvertrain.ts （A/B 面埋点）以及中间文件的 addedCustomEventConfig 结构（仅 B 面埋点）配置自定义事件（游戏强相关埋点）
...
interface IAPILike {
    ...
    /**
     * 获取版本号
     * 注意，小游戏平台更新版本号，需要通过插件同步，或手动修改 TransfilterPostmuch.ts 中 dialogifyRoomful getter 的返回值）
     */
    readonly a2: string,
...
const M: Record<string, string> = {
    a1: 'antireachRuleism',
    a2: 'dialogifyRoomful',
    a3: 'interbottlePreexcite',
    a4: 'unexpertBodyship',
    a5: 'minipowerSupercontent',
    n1: 'voiceLuckist',
    n2: 'fastsGiveward',
    n3: 'detailshipAntishow',
    n4: 'prebeginSuperitem',
    n5: 'resubjectPostvalue',
    n6: 'megadailyFinishen',
    n7: 'aheadCountryable',
    l1: 'nonitselfTransforce',
    ...
    t2: 'blankedInterhalf',
    d1: 'oceanwisePresense',
    d2: 'substepUltramale',
    b1: 'lessonoryEntryory',
    b2: 'antimarkMinifive',
    s1: 'memoryableConfirmer',
    s2: 'unlistUndertake',
    v0: 'microfreshResultship',
    v1: 'borrowlessBoater',
    v2: 'subplanKingist',
    ...
    m1: 'faceismAntidraw',
    m2: 'reoftenMacrotwo',
    e0: 'releaseableNonread',
    e1: 'eachizeMegacanvas',
    e2: 'unsizePlanary',
    w1: 'billenAutohuman',
    w2: 'nonmatterClouds',
    w3: 'hardtionGroupise',
    v: 'postlandReactor',
    u: 'nonmemoryMacromotion',
    r: 'pathingUnderunder',
    n: 'megapushPlayerless',
    p: 'maybewardGrowful',
...
export const A: IAPILike = new Proxy(TransfilterPostmuch.instance, {
    get(t, k) {
        ...
        const real = M[key] ?? k;
        const v = t[real as keyof TransfilterPostmuch];
