...
@ccclass
export default class LevelProgressBar2 extends cc.Component {
    ...
    static ins: LevelProgressBar2 = null

    onLoad() {
        LevelProgressBar2.ins = this;
    ...
    chcecUpdatePro() {
        this.levelConfig.maxLevelReached = FrameSDK.frameData.gameData.passLevel //== 1 ? 0 : FrameSDK.frameData.gameData.passLevel - 1;
    ...
    private renderLevelItems() {
        ...
        for (let i = 0; i < this.currentLevels.length; i++) {
            ...
            const levelItemNode = cc.instantiate(this.levelItemPrefab);
            ...
            if (this.levelConfig.maxLevelReached < fixedWithdrawLevel && level === fixedWithdrawLevel) {
                ...
                currNode.getChildByName("guang1Z").active = false;
            } else { // 此关卡未解锁
