...
export default class newHand extends cc.Component {
    ...
    openRoot2() {
        ...
        let forStr = "20000";
        if(FRAME_CONF && FRAME_CONF.newHand) {
            forStr = this.formatNumber(FRAME_CONF.newHand.max);
        }
        cc.find("label_2", this.root2).getComponent(cc.Label).string = forStr;
...
{"key":"nkey_002","zh":"平台担保","en":"Platform Guarantee","es":"Garantía de la Plataforma","fr":"Garantie de la plateforme","ja":"プラットフォーム保証","de":"Plattform-Garantie","ru":"Гарантия платформы","pt":"Garantia da Plataforma","in":"Jaminan Platform","vi":"Nền tảng bảo đảm","ar":"ضمان المنصة","th":"แพลตฟอร์มรับประกัน","ko":"플랫폼 보증","fil":"Garantiya ng Platform","ms":"Jaminan Platform","hi":"प्लेटफ़ॉर्म गारंटी","tr":"Platform Garantisi"},
{
    ...
    "key": "nkey_005",
    "zh": "挪动麻将完成匹配消除即可赚钱，通过第xxx_1关，收集到的所有货币，都可提现",
    "en": "Match Mahjong tiles to clear to earn money. Pass level xxx_1 to withdraw all collected currency.",
    "es": "Mueve fichas de mahjong para combinarlas, eliminarlas y ganar dinero. ¡Pasa el nivel xxx_1 para retirar todas las monedas recolectadas!",
    "fr": "Déplacez les tuiles de mahjong pour les associer, les éliminer et gagner de l'argent. Passez le niveau xxx_1 pour retirer toutes les devises collectées !",
    "ja": "麻雀牌を動かしてマッチ・消去して稼ぎましょう。レベルxxx_1をクリアすると、集めたすべての通貨が出金可能です。",
    "de": "Bewege Mahjong-Kacheln, um sie zu kombinieren, zu löschen und Geld zu verdienen. Bestehe Level xxx_1, um alle gesammelten Währungen abzuheben!",
    "ru": "Передвигайте плитки маджонга для совпадения и удаления, чтобы зарабатывать деньги. Пройдите уровень xxx_1, чтобы вывести всю собранную валюту!",
    "pt": "Mova as peças de mahjong para combinar, eliminar e ganhar dinheiro. Passe o nível xxx_1 para sacar todas as moedas coletadas!",
    "in": "Geser ubin mahjong untuk mencocokkan, menghapus, dan menghasilkan uang. Lewati level xxx_1 untuk menarik semua mata uang yang dikumpulkan!",
    "vi": "Di chuyển gạch mạt chược để ghép cặp và xóa để kiếm tiền. Vượt qua màn xxx_1 để rút toàn bộ tiền xu đã thu thập!",
    "ar": "أزل مجموعة واحدة لكسب المال. اجتز المستوى xxx_1 لسحب كل العملات التي تم جمعها.",
    "th": "ขยับไพ่นกกระจอกเพื่อจับคู่และลบเพื่อรับเงิน ผ่านด่าน xxx_1 ก็สามารถถอนเงินทั้งหมดที่สะสมได้!",
    "ko": "마작 패를 이동해 매칭 및 제거하여 돈을 버세요. xxx_1 레벨을 클리어하면 수집한 모든 재화를 출금할 수 있습니다.",
    "fil": "I-move ang mahjong tiles para mag-match, mag-clear, at kumita ng pera. Ipasa ang level xxx_1 para ma-withdraw ang lahat ng nakolektang currency!",
    "ms": "Gerak jubin mahjong untuk padan, padam & jana wang. Lepasi tahap xxx_1 untuk keluar semua mata uang yang dikumpul!",
    "hi": "पैसे कमाने के लिए महजोंग टाइलें हिलाएँ, मिलान करें और साफ़ करें। एकत्रित की गई सभी मुद्रा निकालने के लिए स्तर xxx_1 पार करें!",
    "tr": "Para kazanmak için mahjong taşlarını taşı, eşleştir ve temizle. Toplanan tüm para birimini çekmek için seviye xxx_1'i geç!"
},
 {
    "key": "nkey_006",
    "zh": "提现",
